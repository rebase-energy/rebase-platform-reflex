                ...
                rx.el.form(
                    rx.el.div(
                        ...
                        rx.el.input(
                            ...
                            class_name="w-full bg-gray-800 border border-gray-600 rounded-md px-3 py-2 text-white mt-1 focus:outline-none focus:ring-1 focus:ring-green-500",
                        ),
                        class_name="mb-4",
                    ),
                    rx.el.div(
                        ...
                        rx.el.select(
                            ...
                            name="site_type",
                            class_name="w-full bg-gray-800 border border-gray-600 rounded-md px-3 py-2 text-white mt-1 focus:outline-none focus:ring-1 focus:ring-green-500 appearance-none",
                        ),
                        class_name="mb-4",
                    ),
                    rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.button(
                            "Create Site",
                            type_="submit",
                            class_name="bg-green-600 text-white px-4 py-2 rounded-md font-medium hover:bg-green-700",
                        ),
